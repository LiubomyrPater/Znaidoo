...
+function (a) {
    ...
    function b(b) {
        return this.each(function () {
            ...
            e || d.data("bs.carousel", e = new c(this, f)), "serialNumber" == typeof b ? e.to(b) : g ? e[g]() : f.interval && e.pause().cycle()
        })
    }
    ...
    c.VERSION = "3.3.5", c.TRANSITION_DURATION = 150, c.DEFAULTS = {
        ...
        return b = a.extend({}, this.getDefaults(), this.$element.data(), b), b.delay && "serialNumber" == typeof b.delay && (b.delay = {
            show: b.delay,
            hide: b.delay
        }), b
